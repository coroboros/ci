...
### Documentation
- `README.md` describes the 3-job model + Quick start + `check-docs` and `javascript/base` composables.
- `docs/examples.md` — consumer wire-up for `javascript-npm-packages.yml` + standalone `security.yml` + composing with `check-docs` and `javascript/base`.
